...
class MLPTrainer(BaseTrainer):
    """
    BaseTrainer for the Multi Layer Perceptron Model
    """

    def __init__(self, 
                 model: MLPModel, 
                 data_loader: NamesDataLoader):
        """
        ...
        self.xs, self.ys = self.data_loader.create_dataset(block_size=model.block_size)
